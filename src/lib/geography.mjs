...
export const COUNTRIES = {
  ...
  Indonesia:  { continent: 'asia',   region: 'Southeast Asia',  currency: 'IDR' },
  Malaysia:   { continent: 'asia',   region: 'Southeast Asia',  currency: 'MYR' },
  Singapore:  { continent: 'asia',   region: 'Southeast Asia',  currency: 'SGD' },
  'Sri Lanka': { continent: 'asia',  region: 'South Asia',      currency: 'LKR' },
  ...
  Oman:       { continent: 'asia',   region: 'Middle East',     currency: 'OMR' },
  'South Korea': { continent: 'asia', region: 'East Asia',      currency: 'KRW' },
  Austria:    { continent: 'europe', region: 'Central Europe',  currency: 'EUR' },
  Greece:     { continent: 'europe', region: 'Southern Europe', currency: 'EUR' },
  Switzerland: { continent: 'europe', region: 'Central Europe', currency: 'CHF' },
  Egypt:      { continent: 'africa', region: 'North Africa',    currency: 'EGP' },
  Morocco:    { continent: 'africa', region: 'North Africa',    currency: 'MAD' },
  'South Africa': { continent: 'africa', region: 'Southern Africa', currency: 'ZAR' },
  Seychelles: { continent: 'africa', region: 'Indian Ocean Islands', currency: 'SCR' },
  ...
  Germany:    { continent: 'europe', region: 'Western Europe',  currency: 'EUR' },
  'United Kingdom': { continent: 'europe', region: 'Northern Europe', currency: 'GBP' },
